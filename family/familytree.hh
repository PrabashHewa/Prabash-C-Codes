...
struct Person
{
    ...
    // Default constructor
    Person() = default;  // This will generate a default constructor

    // Parameterized constructor
    Person(const std::string& id, int height)
        : id_(id), height_(height) {}
...
private:
    ...
    // Utility functions
    bool personExists(const std::string& id) const;
    void loadFromFile(const std::string& filename, std::ostream& output);
